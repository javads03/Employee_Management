...
const constraints_2 = require("../utils/constraints");
...
class AuthService {
    ...
    login(email, password) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const token = jsonwebtoken_1.default.sign(payload, constraints_2.JWT_SECRET, { expiresIn: constraints_1.JWT_VALIDITY });
            return {
                tokenType: "Bearer",
                accessToken: token
            };
